    ...
    if(isset($_POST['update_profile'])){
        ...
        if(!empty($update_image)){
            if($update_image_size > 2000000){
                ...
                $image_update_query = mysqli_query($conn, "UPDATE `user_infor` SET user_picture = '$update_image' WHERE user_id = '$user_id'") or die('query failed');
                ...
                <form action="#" method="post" enctype="multipart/form-data">
                    <div class="edit_header">
                        <div class="profile-pic-div">
                            <img src="../img/uploaded_img/<?php echo $fetch['user_picture']; ?>" alt="user-profile-pic" id="profile_pic">
